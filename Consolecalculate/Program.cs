namespace Consolecalculate
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                Console.Write("Введите операцию (+, -, *, /): "); string op = Console.ReadLine();

                Console.Write("\nВведите первое число: "); double a = double.Parse(Console.ReadLine());
                ...
                switch (op)
                {
                    ...
                    case "/":
                        if (b != 0) result = Calculator.Divide(a, b); else Console.WriteLine("Ошибка: деление на ноль!"); break;
                    default:
                        Console.WriteLine("Неизвестная операция!"); continue;
                }
